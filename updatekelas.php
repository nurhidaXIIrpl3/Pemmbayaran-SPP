...
if (isset($_POST["ok"])) {
    ...
    $kompetensi_kejuruan = $_POST["kompetensi_kejuruan"];
    $input = mysqli_query($koneksi, "UPDATE kelas SET nama_kelas='$nama_kelas', kompetensi_kejuruan='$kompetensi_kejuruan' WHERE id_kelas='$id_kelas'");
